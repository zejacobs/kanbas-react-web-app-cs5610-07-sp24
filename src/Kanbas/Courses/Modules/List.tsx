    ...
    <div className="flex-fill">
      ...
      <div className="row">
        <div className="col">
          ...
          <button className="btn btn-success ms-2 rounded" onClick={() => dispatch(addModule({ ...module, course: courseId }))}>
            Add
          </button>
          <button className="btn btn-primary ms-2" onClick={() => dispatch(updateModule(module))}>
            Update
          </button>
        </div>
      </div>
            ...
            <li key={index} className="list-group-item" /*onClick={() => setSelectedModule(module)}*/>
              <div>
                ...
                <span className="float-end">
                  ...
                  <button className="btn btn-danger rounded ms-2 px-1" onClick={() => dispatch(deleteModule(module._id))}>
                    Delete
                  </button>
